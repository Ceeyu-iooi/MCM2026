...
# 加载主数据
data_path = os.path.join(os.path.dirname(SCRIPT_DIR), 'processed_dwts_cleaned_ms08.csv')
df = pd.read_csv(data_path)

# 加载预测的观众投票
fan_votes_path = os.path.join(os.path.dirname(SCRIPT_DIR), 'q1', 'q1_rf_predicted_fan_votes.csv')
...
# 计算Logistic回归的伪R²（McFadden's R²）
# McFadden R² = 1 - (log-likelihood / null log-likelihood)
