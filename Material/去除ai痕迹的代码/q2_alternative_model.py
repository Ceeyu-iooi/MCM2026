...
for method, color in [("rank_method", "steelblue"), ("percentage_method", "coral")]:
    ...
    # 标注点和线的含义
    if method == "rank_method":
        # Mean annotation moved below the line
        ax2.annotate('Mean (Point Estimate)', xy=(mean, y_pos), xytext=(0, -25),
                     textcoords='offset points',
                     arrowprops=dict(facecolor='black', arrowstyle='->', alpha=0.5),
                     ha='center', fontsize=9)
        ax2.annotate('95% Confidence Interval', xy=(ci_upper, y_pos), xytext=(ci_upper + 2, y_pos),
                     arrowprops=dict(facecolor='black', arrowstyle='->', alpha=0.5),
