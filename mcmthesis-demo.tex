...
Extreme weather events are becoming more frequent due to climate change. As the economic
costs of disasters rise, how should the insurance industry respond to losses? Extreme
...
the losses arise from a small number of lumpy events, the insurer may not have sufficient resources
to cover the losses. Less dramatically, the firm may suffer losses well in excess of the
...
premiums will rise \cite{born2006}.
...
\begin{itemize}
\item {\bf Problem 1:} The property insurance industry faces a crisis from increased extreme
weather events caused by climate change, leading to higher claims and premiums.
\item {\bf roblem 2:} Insurance companies must decide on underwriting policies in weather-affected
regions, balancing risk and long-term viability.
\item {\bf Problem 3:} Participants are tasked with creating a model to assist in underwriting decisions
and a preservation model for community leaders to protect significant buildings.
\item {\bf Problem4:} The models should be applied to specific areas and a historic landmark, with
